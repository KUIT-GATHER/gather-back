...
class PhoneVerificationCleanupSchedulerTest {

    @Mock private PhoneVerificationCleanupService cleanupService;

    private PhoneVerificationCleanupScheduler scheduler;

    @BeforeEach
    void setUp() {
        scheduler = new PhoneVerificationCleanupScheduler(cleanupService);
    }
