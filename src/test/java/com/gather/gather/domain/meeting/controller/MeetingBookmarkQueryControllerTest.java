...
@WebMvcTest(MeetingBookmarkQueryController.class)
@AutoConfigureMockMvc(addFilters = false)
class MeetingBookmarkQueryControllerTest {
    ...
    @Test
    @DisplayName("GET /api/v1/meetings/bookmarks returns 200 with bookmarked meetings")
    void getBookmarkedMeetings_returns200WithContent() throws Exception {
    ...
    @Test
    @DisplayName("GET /api/v1/meetings/bookmarks passes category and keyword query params through")
