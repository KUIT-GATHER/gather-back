...
@Component
public class ProfileImageContentValidator {
    ...
    public void validate(ProfileImageFormat format, byte[] content) {
        boolean valid =
                switch (format) {
        ...
        if (!valid) {
            throw new BusinessException(ErrorCode.INVALID_PROFILE_IMAGE_CONTENT);
        }
    }
